defmodule <%= @web_module %>.HomeLive do
  @moduledoc """
  Clean welcome page generated by `mix joby_kit.new`. Uses the kit's
  `simple_nav` and a few daisyUI primitives so the project starts as a
  working JobyKit demo instead of the default Phoenix marketing page.
  ...
  def render(assigns) do
    ...
    <Layouts.app flash={@flash}>
      <JobyKit.NavComponent.simple_nav active="home" brand="<%= @app_camel %>" />
